export const policydummy = [
  {
    ...
    startDate: "25.01.01",
    endDate: "25.01.15",
    supplyfor: "- 지원대상: 서울특별시 거주 어르신",
    standard: "- 선정기준: 65세 이상 저소득층",
  ...
  },
  {
    ...
    content: "- 신청접수처 : 중소기업청 및 온라인 신청 - 지급시기 : 신청 후 3개월 이내",
    total: "2000",
    age: "사업자 대상",
  ...
  },
  {
    ...
    content: "- 신청접수처 : 복지센터 및 읍면동사무소 - 지급시기 : 연중 신청 가능",
    total: "2500",
    age: "전 연령",
  ...
  // 지원정책 ("치료") 관련 키워드 6개
  {
    ...
    standard: "- 선정기준 : 장애등급 1~3급 해당자 및 소득 기준 중위소득 120% 이하",
    content: "- 신청접수처 : 서울병원 본관 305호\n- 지원 내용 : 재활 치료비, 보조기기 구매비, 맞춤형 건강관리 서비스 제공",
    total: 5000,
    age: "전 연령",
  ...
  },
  {
    ...
    content: "- 신청접수처 : 전국 보건소 및 지정 의료기관\n- 지원 내용 : 독감, 폐렴, A형간염 등 예방접종 무료 제공",
    total: 3200,
    age: "전 연령",
